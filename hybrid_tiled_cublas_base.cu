...
// Computes a BLOCK_SIZE x BLOCK_SIZE tile of C per block,
// where each thread computes a 2x2 sub-tile
__global__ void matmul_kernel_tiled_regtile(
...
// Hybrid host function: selects the custom kernel for small matrices,
// and uses cuBLAS for larger ones
